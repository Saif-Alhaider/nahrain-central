        ...
        <div className={'bg-background scroll-smooth'}>
            ...
            <div className='mt-4 lg:mt-12 flex xl:flex-row xl:gap-0 flex-col gap-4'>
                ...
                <div
                    ...
                    <div className={'flex flex-col w-[209px]'}>
                        <ThemeModeCard className={'light p-6 box-content bg-softGray rounded-xl'}/>
                    ...
                    <div className={'flex flex-col w-[209px]'}>
                        <ThemeModeCard className={'dark p-6 box-content bg-softGray rounded-xl'}/>
                    ...
                    <div className={'flex flex-col w-[209px]'}>
                        <ThemeSplitModeCard className={'p-6 box-content bg-softGray rounded-xl'}/>
            ...
            <hr className="border border-strokeGray unselectable mt-4 mx-6"/>
            <div className={'mx-6 lg:my-8 my-4 flex lg:flex-row flex-col justify-between lg:items-center gap-2'}>
                <div className={'flex flex-col justify-between'}>
