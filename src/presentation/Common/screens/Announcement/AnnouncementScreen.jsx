    ...
    return (
        <div className={`bg-background p-6 text-onBackground`}>
            ...
            <div className={`flex flex-col md:flex-row gap-6 my-6 w-full`}>
                ...
                <div
                    className="md:self-stretch md:w-[2px] md:h-[inheirit] md:border-none border-t-1 border border-softGray w-full bg-softGray rounded-2xl flex-grow"
                />
                <div className={`flex-grow w-full flex flex-col gap-4`}>
                    <AnnouncementLinks/>
                    <AnnouncementDateAndTime/>
                    <AnnouncementSubject/>
                    <AnnouncementStage/>
                </div>
            </div>
            ...
            <div className="mt-6 border border-onBackgroundCaption rounded-t-lg">
                <h1 className="text-onBackground bg-card h-12 ps-4 flex items-center visible sm:hidden rounded-t-lg">Students Scheduled for the Exam</h1>
...
const AnnouncementLinks = () => {
    return (
        <AnnouncementInfoTemplate title="Linked Docs" icon={<IcLink/>}>
...
const AnnouncementDateAndTime = () => {
    return (
        <AnnouncementInfoTemplate title="Date and Time" icon={<Iclock/>}>
...
const AnnouncementSubject = () => {
    return (
        <AnnouncementInfoTemplate title="Subject" icon={<IcNoteBook/>}>
            <h3 className={`text-onBackgroundCaption font-medium text-lg line-clamp-2 max-w-[300px]`}>Network Communications and
                Protocols</h3>
        </AnnouncementInfoTemplate>
...
const AnnouncementStage = () => {
    return (
        <AnnouncementInfoTemplate title="Stage" icon={<IcUsers/>}>
            <h3 className={`text-onBackgroundCaption font-medium text-lg line-clamp-2 max-w-[300px]`}>Sophomore Students</h3>
        </AnnouncementInfoTemplate>
    )
}
