        ...
        <Sidebar onDismiss={onDismiss} isVisible={isVisible} className={className}>
            <div className="flex flex-col h-full w-full">
                ...
                <div className="flex flex-col gap-2 overflow-y-auto unselectable">
                    <MenuItem onDismiss={onDismiss} icon={IcHome} text={t("home")} to='/nahrain-central'
                              isActive={currentScreen === t("home")}/>
                    <MenuItem onDismiss={onDismiss} icon={IcCalendar} to='/nahrain-central/lectures-schedule'
                              text={t('lectures_schedule')} isActive={currentScreen === t('lectures_schedule')}/>
                    <MenuItem onDismiss={onDismiss} icon={IcPlay} to='/nahrain-central/recorded-lectures'
                ...
                <div className="flex-grow flex flex-col justify-end gap-2 mt-4">
                    <MenuItem onDismiss={onDismiss} icon={IcSettings} to='/nahrain-central/settings'
                              text={t("settings")} isActive={currentScreen === t("settings")}/>
                    <MenuItem onDismiss={onDismiss} icon={IcUser} to='/nahrain-central/contact-me'
